...
# Histogram: X = Kilowatts, Y = Freqency

# Generate & Save plot to file "Plot1.png"
png(filename = "plot1.png", width = 480, height = 480)
hist(data_filter$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
dev.off()